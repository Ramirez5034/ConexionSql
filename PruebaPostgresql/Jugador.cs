...
namespace PruebaPostgresql
{
    public partial class Jugador : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "INSERT INTO Jugador(Usuario, Contrasena, Correo, idEnlinea, idMembresia) values('" + Usuario + "', '" + Contraseña + "', '" + Correo + "', '" + idEnlinea + "', '" + idMembresia + "')";
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Jugador SET Usuario = '" + Usuario + "'Contrasena = '" + Contraseña + "',Correo = '" + Correo + "',idEnlinea = '" + idEnlinea + "',idMembresia = '" + idMembresia + "' WHERE idJugador = " + idJugador.ToString();
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
