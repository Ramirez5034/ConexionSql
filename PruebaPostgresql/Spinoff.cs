...
namespace PruebaPostgresql
{
    public partial class Spinoff : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionSql.ejecutaConsultaSelect("SELECT *FROM Spinoff ORDER BY idSpinoff");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Spinoff SET Estatus = 0 WHERE idSpinoff =  " + idSpinoff.ToString(); ;
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
