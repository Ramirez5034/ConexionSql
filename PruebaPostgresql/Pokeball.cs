...
namespace PruebaPostgresql
{
    public partial class Pokeball : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionSql.ejecutaConsultaSelect("SELECT *FROM Pokeball ORDER BY idPokeball");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Pokeball SET Estatus = 0 WHERE idPokeball =  " + idPokeball.ToString(); ;
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
