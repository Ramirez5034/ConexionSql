...
namespace PruebaPostgresql
{
    ...
    public partial class Doblaje : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionSql.ejecutaConsultaSelect("SELECT *FROM Doblaje ORDER BY idDoblaje");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Doblaje SET Estatus = 0 WHERE idDoblaje =  " + idDoblaje.ToString(); ;
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
