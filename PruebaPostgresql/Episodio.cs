...
namespace PruebaPostgresql
{
    public partial class Episodio : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionSql.ejecutaConsultaSelect("SELECT *FROM Episodio ORDER BY idEpisodio");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Episodio SET Estatus = 0 WHERE idEpisodio =  " + idEpisodio.ToString(); ;
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
