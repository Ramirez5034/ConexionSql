...
namespace PruebaPostgresql
{
    public partial class Mecanica : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionSql.ejecutaConsultaSelect("SELECT *FROM Mecanica ORDER BY idMecanica");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Mecanica SET Estatus = 0 WHERE idMecanica =  " + idMecanica.ToString(); ;
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
