...
namespace PruebaPostgresql
{
    public partial class Hackrom : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionSql.ejecutaConsultaSelect("SELECT *FROM Hackrom ORDER BY idHackrom");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Hackrom SET Estatus = 0 WHERE idHackrom =  " + idHackrom.ToString(); ;
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
