...
namespace PruebaPostgresql
{
    public partial class TemporadaVestuario : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionSql.ejecutaConsultaSelect("SELECT *FROM TemporadaVestuario ORDER BY idTemporadaVestuario");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE TemporadaVestuario SET Estatus = 0 WHERE idTemporadaVestuario =  " + idTemporadaVestuario.ToString(); ;
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
