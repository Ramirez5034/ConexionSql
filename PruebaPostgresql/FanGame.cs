...
namespace PruebaPostgresql
{
    public partial class FanGame : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionSql.ejecutaConsultaSelect("SELECT *FROM FanGame ORDER BY idFanGame");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE FanGame SET Estatus = 0 WHERE idFanGame =  " + idFanGame.ToString(); ;
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
