...
namespace PruebaPostgresql
{
    public partial class Estudio : Form
    {
        ...
        {
            dataGridView1.DataSource = ConexionSql.ejecutaConsultaSelect("SELECT *FROM Estudio ORDER BY idEstudio");
        }
        ...
        private void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            consulta = "UPDATE Estudio SET Estatus = 0 WHERE idEstudio =  " + idEstudio.ToString(); ;
            ConexionSql.ejecutaConsulta(consulta);
            MostrarDatos();
        }
