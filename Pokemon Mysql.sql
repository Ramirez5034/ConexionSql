...
(
idContenidodescarga INT NOT NULL auto_increment,
Nombre VARCHAR (50) NOT NULL,
Precio INT NOT NULL,
Fecha DATETIME NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
Primary key (idContenidodescarga)
);
...
CREATE TABLE Contro
(
idContro INT NOT NULL auto_increment,
Numero INT NOT NULL,
Precio INT NOT NULL,
Diseño VARCHAR (50) NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idContro)
);
...
(
idDistribución INT NOT NULL auto_increment,
Lugares VARCHAR (50) NOT NULL,
Pedidos INT NOT NULL,
Transporte VARCHAR (50) NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idDistribución)
);

CREATE TABLE Doblaje
(
idDoblaje INT NOT NULL auto_increment,
Zona VARCHAR (50) NOT NULL,
Director VARCHAR (50) NOT NULL,
Lenguaje VARCHAR (50) NOT NULL,
idAnime INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idDoblaje)
);
...
(
idExclusivo INT NOT NULL auto_increment,
Nombre VARCHAR (50) NOT NULL,
Descripcion VARCHAR (50) NOT NULL,
...
CREATE TABLE Expansionn
(
idExpansion INT NOT NULL auto_increment,
Nombre VARCHAR (50) NOT NULL,
Numero INT NOT NULL,
...
(
idFanGame INT NOT NULL auto_increment,
Numero INT NOT NULL,
Creador VARCHAR (50) NOT NULL,
Nombre VARCHAR (50) NOT NULL,
idGeneracion INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idFanGame)
);
...
CREATE TABLE Guion
(
idGuion INT NOT NULL auto_increment,
Numero INT NOT NULL,
Nombre VARCHAR (50) NOT NULL,
Descripcion VARCHAR (50) NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
...
(
idHackrom INT NOT NULL auto_increment,
Plataforma VARCHAR (50) NOT NULL,
Creador VARCHAR (50) NOT NULL,
Nombre VARCHAR (50) NOT NULL,
idVideojuego INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idHackrom)
);
...
(
idMecanica INT NOT NULL auto_increment,
Nombre VARCHAR (50) NOT NULL,
Descripcion VARCHAR (50) NOT NULL,
Activacion VARCHAR (50) NOT NULL,
idGeneracion INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idMecanica)
);
...
(
idEnlinea INT NOT NULL auto_increment,
Numero INT NOT NULL,
Host INT NOT NULL,
Personas INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idEnlinea)
);
...
(
idSpinoff INT NOT NULL auto_increment,
Nombre VARCHAR (50) NOT NULL,
Numero INT NOT NULL,
Ventas INT NOT NULL,
idGeneracion INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idSpinoff)
);
...
(
idTransmisión INT NOT NULL auto_increment,
Canal VARCHAR (50) NOT NULL,
Numero INT NOT NULL,
Horario DATETIME NOT NULL,
idAnime INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idTransmisión)
);

CREATE TABLE Versión
(
idVersión INT NOT NULL auto_increment,
Nombre VARCHAR (50) NOT NULL,
Fechasalida DATETIME NOT NULL,
Fechaactualizacion DATETIME NOT NULL,
idVideojuego INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idVersión)
);

CREATE TABLE Vestuario
(
idVestuario INT NOT NULL auto_increment,
Nombre VARCHAR (50) NOT NULL,
Numero INT NOT NULL,
Diseño VARCHAR (50) NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idVestuario)
);
...
(
idAnimeEpisodio INT NOT NULL auto_increment,
idAnime INT NOT NULL,
idEpisodio INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idAnimeEpisodio)
);

CREATE TABLE AnimeEspecial
(
idAnimeEspecial INT NOT NULL auto_increment,
idAnime INT NOT NULL,
idEspecial INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idAnimeEspecial)
);

CREATE TABLE AnimePelicula
(
idAnimePelicula INT NOT NULL auto_increment,
idAnime INT NOT NULL,
idPelicula INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idAnimePelicula)
);

CREATE TABLE ConsolaContro
(
idConsolaContro INT NOT NULL auto_increment,
idConsola INT NOT NULL,
idContro INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idConsolaContro)
);

CREATE TABLE ConsolaVideojuego
(
idConsolaVideojuego INT NOT NULL auto_increment,
idConsola INT NOT NULL,
idVideojuego INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idConsolaVideojuego)
);

CREATE TABLE DistribucionMercancia
(
idDistribucionMercancia INT NOT NULL auto_increment,
idDistribución INT NOT NULL,
idMercancia INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idDistribucionMercancia)
);

CREATE TABLE GeneracionEntrenador
(
idGeneracionEntrenador INT NOT NULL auto_increment,
idGeneracion INT NOT NULL,
idEntrenador INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idGeneracionEntrenador)
);

CREATE TABLE GeneracionMercancia
(
idGeneracionMercancia INT NOT NULL auto_increment,
idGeneracion INT NOT NULL,
idMercancia INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idGeneracionMercancia)
);

CREATE TABLE ColaboracionCarta
(
idColaboracionCarta INT NOT NULL auto_increment,
idColaboracion INT NOT NULL,
idCarta INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idColaboracionCarta)
);

CREATE TABLE CartaArtista
(
idCartaArtista INT NOT NULL auto_increment,
idArtista INT NOT NULL,
idCarta INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idCartaArtista)
);

CREATE TABLE MangaImprenta
(
idMangaImprenta INT NOT NULL auto_increment,
idManga INT NOT NULL,
idImprenta INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idMangaImprenta)
);

CREATE TABLE MercanciaPagina
(
idMercanciaPagina INT NOT NULL auto_increment,
idMercancia INT NOT NULL,
idPagina INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
Primary key (idMercanciaPagina)
);

CREATE TABLE ObjetoTienda
(
idObjetoTienda INT NOT NULL auto_increment,
idObjeto INT NOT NULL,
idTienda INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idObjetoTienda)
);

CREATE TABLE PokeballTienda
(
idPokeballTienda INT NOT NULL auto_increment,
idPokeball INT NOT NULL,
idTienda INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idPokeballTienda)
);

CREATE TABLE TemporadaSkin
(
idTemporadaSkin INT NOT NULL auto_increment,
idTemporada INT NOT NULL,
idSkin INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idTemporadaSkin)
);

CREATE TABLE TemporadaVestuario
(
idTemporadaVestuario INT NOT NULL auto_increment,
idTemporada INT NOT NULL,
idVestuario INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idTemporadaVestuario)
);

CREATE TABLE TorneoVideojuego
(
idTorneoVideojuego INT NOT NULL auto_increment,
idTorneo INT NOT NULL,
idVideojuego INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idTorneoVideojuego)
);

CREATE TABLE VideojuegoEvento
(
idVideojuegoEvento INT NOT NULL auto_increment,
idVideojuego INT NOT NULL,
idEvento INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idVideojuegoEvento)
);

CREATE TABLE VideojuegoJugador
(
idVideojuegoJugador INT NOT NULL auto_increment,
idVideojuego INT NOT NULL,
idJugador INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idVideojuegoJugador)
);

CREATE TABLE VideoJuegoColaboracion
(
idVideojuegoColaboracion INT NOT NULL auto_increment,
idVideojuego INT NOT NULL,
idColaboracion INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idVideoJuegoColaboracion)
);

CREATE TABLE VideoJuegoContenidodescarga
(
idVideojuegoContenidodescarga INT NOT NULL auto_increment,
idVideojuego INT NOT NULL,
idContenidodescarga INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idVideojuegoContenidodescarga)
);

CREATE TABLE PlataformaAplicacion
(
idPlataformaAplicacion INT NOT NULL auto_increment,
idPlataforma INT NOT NULL,
idAplicacion INT NOT NULL,
estatus BIT DEFAULT 1 NOT NULL,
primary key (idPlataformaAplicacion)
);
...
CREATE INDEX IX_Expansionn ON Expansionn(idExpansion);
...
FOREIGN  KEY(idExpansion) REFERENCES Expansionn(idExpansion);
...
INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(1, 'Votacion', current_timestamp());

INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(2, 'EasterEgg', current_timestamp());

INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(3, 'Votacion', current_timestamp());

INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(4, 'Canción', current_timestamp());

INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(5, 'Votacion', current_timestamp());

INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(6, 'Diseño', current_timestamp());

INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(7, 'Marca', current_timestamp());

INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(8, 'Encuesta', current_timestamp());

INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(9, 'Aparición', current_timestamp());

INSERT INTO	Colaboracion(numero, tipo, fecha) VALUES(10, 'Juego', current_timestamp());
...
INSERT INTO	Contenidodescarga(nombre, precio, fecha) VALUES('Nieves de corona', 2000, current_timestamp());

INSERT INTO	Contenidodescarga(nombre, precio, fecha) VALUES('Pokemon nuevo', 2000, current_timestamp());

INSERT INTO	Contenidodescarga(nombre, precio, fecha) VALUES('Competitivo', 2000, current_timestamp());

INSERT INTO	Contenidodescarga(nombre, precio, fecha) VALUES('Apoyo de captura', 2000, current_timestamp());

INSERT INTO	Contenidodescarga(Nombre, Precio, Fecha) VALUES('Arceus DLC', 2000, current_timestamp());

INSERT INTO	Contenidodescarga(Nombre, Precio, Fecha) VALUES('Isla Armadura', 10000, current_timestamp());

INSERT INTO	Contenidodescarga(Nombre, Precio, Fecha) VALUES('UltraEntes', 21000, current_timestamp());

INSERT INTO	Contenidodescarga(Nombre, Precio, Fecha) VALUES('Suicune y virizion paradox', 32000, current_timestamp());

INSERT INTO	Contenidodescarga(Nombre, Precio, Fecha) VALUES('Pokeballs', 24000, current_timestamp());

INSERT INTO	Contenidodescarga(Nombre, Precio, Fecha) VALUES('Historia', 2000, current_timestamp());
...
Select *From Contro;
INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES(823, 'Julian', 'VECJ880326 XXX');

INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES('863', 'Marcos', 'VECJ880326 XXX');

INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES('324', 'Tencent', 'VECJ880326 XXX');

INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES('835', 'Gamefreak', 'VECJ880326 XXX');

INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES('862', 'Pablo', 'VECJ880326 XXX');

INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES('523', 'Megan', 'VECJ880326 XXX');

INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES('836', 'Shiro', 'VECJ880326 XXX');

INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES('854', 'Lina', 'VECJ880326 XXX');

INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES('853', 'Fani', 'VECJ880326 XXX');

INSERT INTO	Desarrollador(Telefono, Nombre, RFC) VALUES('864', 'Axel', 'VECJ880326 XXX');

UPDATE Desarrollador SET Telefono = '866' WHERE idDesarrollador = 2;
...
INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(1, 'Pokes de ash', current_timestamp());

INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(2, 'Zorua Shiny', current_timestamp());

INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(3, 'Eeve', current_timestamp());

INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(4, 'Pokemon go fest', current_timestamp());

INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(5, 'Pokemon go fiesta', current_timestamp());

INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(6, 'Eternatus', current_timestamp());

INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(7, 'Diancie', current_timestamp());

INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(8, 'Volcanion', current_timestamp());

INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(9, 'Zarude', current_timestamp());

INSERT INTO	Evento(Numero, Nombre, Fecha) VALUES(10, 'Blastoise', current_timestamp());
...
select *from Estudio;
INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('Resplandor', 1, current_timestamp());

INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('Rojo', 2, current_timestamp());

INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('Oro', 3, current_timestamp());

INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('Espada', 4, current_timestamp());

INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('Escudo', 5, current_timestamp());

INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('Leyendas', 6, current_timestamp());

INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('Ascenso', 7, current_timestamp());

INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('Poder', 8, current_timestamp());

INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('sonico', 9, current_timestamp());

INSERT INTO	Expansionn(Nombre, Numero, FechaSalida) VALUES('Rebelion', 10, current_timestamp());

UPDATE Expansionn SET Nombre = 'prueba' WHERE idExpansion = 2;
DELETE FROM Expansionn WHERE idExpansion = 1;
select *from Expansionn;
...
INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(120, current_timestamp(), 1);

INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(130, current_timestamp(), 2);

INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(120, current_timestamp(), 3);

INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(123, current_timestamp(), 4);

INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(121, current_timestamp(), 5);

INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(112, current_timestamp(), 6);

INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(120, current_timestamp(), 7);

INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(1123, current_timestamp(), 8);

INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(600, current_timestamp(), 9);

INSERT INTO	Membresia(Precio, FechaSalida, Numero) VALUES(131, current_timestamp(), 10);
...
select *from Pokedex;
INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('PokemonViolet', current_timestamp(), 'WWW.pokemon.com');

INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('Wiki', current_timestamp(), 'WWW.Wikidex.com');

INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('PokemonNormal', current_timestamp(), 'WWW.Nintendo.com');

INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('Pokemon de cartas',  current_timestamp(), 'WWW.TCG.com');

INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('información y imagenes', current_timestamp(), 'WWW.ClubEntrenadorwa.com');

INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('Pokemon con juegos', current_timestamp(), 'WWW.pokemonjuegos.com');

INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('Pokemon blanco y negro con sus juegos', current_timestamp(), 'WWW.CartoonNetwork.com');

INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('PokemonViolet', current_timestamp(), 'WWW.pokemonTienda.com');

INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('PokemonScarlet', current_timestamp(), 'WWW.pokemonInfo.com');

INSERT INTO	Pagina(Diseño, FechaCreacion, Link) VALUES('PokemonZafiro', current_timestamp(), 'WWW.pokemonLive.com');
...
INSERT INTO	Generacion(FechaSalida, Numero, Descripcion,idPokedex) VALUES(current_timestamp(), 1, 'La primera generación en kanto', 2);

INSERT INTO	Generacion(FechaSalida, Numero, Descripcion, idPokedex) VALUES(current_timestamp(), 2, 'La segunda generación en Johto', 2);

INSERT INTO	Generacion(FechaSalida, Numero, Descripcion, idPokedex) VALUES(current_timestamp(), 3, 'La Tercera generación en hoenn', 3);

INSERT INTO	Generacion(FechaSalida, Numero, Descripcion, idPokedex) VALUES(current_timestamp(), 4, 'La Cuarta generación en Sinnoh', 4);

INSERT INTO	Generacion(FechaSalida, Numero, Descripcion, idPokedex) VALUES(current_timestamp(), 5, 'La quinta generación en Unova', 5);

INSERT INTO	Generacion(FechaSalida, Numero, Descripcion, idPokedex) VALUES(current_timestamp(), 6, 'La sexta generación en kalos', 6);

INSERT INTO	Generacion(FechaSalida, Numero, Descripcion, idPokedex) VALUES(current_timestamp(), 7, 'La septima generación en Alola', 7);

INSERT INTO	Generacion(FechaSalida, Numero, Descripcion, idPokedex) VALUES(current_timestamp(), 8, 'La Octava generación en galar', 8);

INSERT INTO	Generacion(FechaSalida, Numero, Descripcion, idPokedex) VALUES(current_timestamp(), 9, 'La Novena generación en hisui', 10);

INSERT INTO	Generacion(FechaSalida, Numero, Descripcion, idPokedex) VALUES(current_timestamp(), 10, 'La Decima generación en Paldea', 9);

UPDATE Generacion SET Numero = '11' WHERE idGeneracion = 2;
...
select *from Tienda;
INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'Liga añil', current_timestamp(), 2, 2, 2);

INSERT INTO Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'Liga naranja', current_timestamp(), 4,2, 2);

INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'Liga Johto', current_timestamp(), 3, 3, 2);

INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'Advanced', current_timestamp(), 3, 4, 2);

INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'Hoenn', current_timestamp(), 2, 5, 2);

INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'Shinooh', current_timestamp(), 4, 6, 3);

INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'Unova', current_timestamp(), 5, 7, 2);

INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'Kalos', current_timestamp(), 6, 2 , 2);

INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'XYZ', current_timestamp(), 7, 2, 2);

INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'XY', current_timestamp(), 6, 2, 2);

INSERT INTO	Anime(Fechainicio, Nombre, FechaFinalización, idGeneracion, idGuion, idEstudio) VALUES(current_timestamp(), 'Alola', current_timestamp(), 7, 2, 2);
...
Select *from Artista;
INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'PokemonRojo', 1233, 2, 2);

INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'Pokemonazul', 1233, 2, 2);

INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'PokemonOro', 2134, 2, 2);

INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'PokemonPlata', 5424, 2, 2);

INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'PokemonRuby', 8764, 3, 3);

INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'PokemonZafiro', 1233, 3, 3);

INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'PokemonEscudo', 645322, 8, 8);

INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'PokemonEspada', 1233, 8, 8);

INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'PokemonPlatino', 1231, 4, 4);

INSERT INTO	Videojuego(FechaSalida, Nombre, CopiasVendidas, idGeneracion, idDesarrollador) VALUES(current_timestamp(), 'PokemonBlanco', 7432, 5, 5);

UPDATE Videojuego SET Nombre = 'Prueba' WHERE idVideojuego = 2;
DELETE FROM Videojuego WHERE idVideojuego = 1;
select *from Videojuego;
INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada1', 1, current_timestamp(), current_timestamp(), 2);

INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada2', 2, current_timestamp() , current_timestamp(), 2);

INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada3', 3, current_timestamp() , current_timestamp(), 3);

INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada4', 4, current_timestamp() , current_timestamp(), 4);

INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada5', 5, current_timestamp() , current_timestamp(), 6);

INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada6', 6, current_timestamp() , current_timestamp(), 2);

INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada7', 7, current_timestamp() , current_timestamp(), 2);

INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada8', 8, current_timestamp(), current_timestamp(), 2);

INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada9', 9, current_timestamp(), current_timestamp(), 2);

INSERT INTO	Temporada(Nombre, Numero, Fechainicio, Fechafinal, idVideojuego) VALUES('Temporada10', 10, current_timestamp() , current_timestamp(), 3);

UPDATE Temporada SET Nombre = 'Prueba' WHERE idTemporada = 2;
DELETE FROM Temporada WHERE idTemporada = 1;
select *from Temporada;
INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal1', 1, current_timestamp() , 2);

INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal2', 2, current_timestamp() , 2);

INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal3', 3, current_timestamp() , 3);

INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal4', 4, current_timestamp() , 4);

INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal5', 5, current_timestamp() , 4);

INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal6', 6, current_timestamp() , 5);

INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal7', 7, current_timestamp() , 6);

INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal8', 8, current_timestamp() , 7);

INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal9', 9, current_timestamp() , 8);

INSERT INTO	Transmisión(Canal, Numero, Horario, idAnime) VALUES('Canal10', 10, current_timestamp() , 9);
...
INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(1, current_timestamp(), 'Rareza1', 2);

INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(2, current_timestamp(), 'Rareza2', 2);

INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(3, current_timestamp(), 'Rareza3', 3);

INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(4, current_timestamp(), 'Rareza1', 2);

INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(5, current_timestamp(), 'Rareza1', 5);

INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(6, current_timestamp(), 'Rareza6', 6);

INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(7, current_timestamp(), 'Rareza7', 7);

INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(8, current_timestamp(), 'Rareza1', 7);

INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(9, current_timestamp(), 'Rareza1', 3);

INSERT INTO	Carta(Codigo, FechaCreacion, Rareza, idExpansion) VALUES(10, current_timestamp(), 'Rareza1', 2);
...
select *from Jugador;
INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 1, current_timestamp(), 'Metodo1', 2);

INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 2, current_timestamp(), 'Metodo2', 2);

INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 3, current_timestamp(), 'Metodo3', 3);

INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 4, current_timestamp(), 'Metodo4', 2);

INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 5, current_timestamp(), 'Metodo5', 5);

INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 6, current_timestamp(), 'Metodo6', 3);

INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 7, current_timestamp(), 'Metodo1', 2);

INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 8, current_timestamp(), 'Metodo2', 3);

INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 9, current_timestamp(), 'Metodo3', 9);

INSERT INTO	Compra(Codigo, Fecha, MetodoPago, idJugador) VALUES( 10, current_timestamp(), 'Metodo1', 9);
...
INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo1', 'Objeto exclusivo', current_timestamp(), 2);

INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo2', 'Objeto exclusivo', current_timestamp(), 2);

INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo3', 'Objeto exclusivo', current_timestamp(), 8);

INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo4', 'Objeto exclusivo', current_timestamp(), 3);

INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo5', 'Objeto exclusivo', current_timestamp(), 2);

INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo6', 'Objeto exclusivo', current_timestamp(), 3);

INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo7', 'Objeto exclusivo', current_timestamp(), 4);

INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo8', 'Objeto exclusivo', current_timestamp(), 8);

INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo9', 'Objeto exclusivo', current_timestamp(), 7);

INSERT INTO	Exclusivo(Nombre, Descripcion, FechaDisponibilidad, idVideojuego) VALUES( 'Exclusivo1o', 'Objeto exclusivo', current_timestamp(), 2);
...
select *from Hackrom;
INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga1', current_timestamp(), 1, 2, 2);

INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga2', current_timestamp(), 2, 2, 2);

INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga3', current_timestamp(), 3, 4, 6);

INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga4', current_timestamp(), 4, 5, 6);

INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga5', current_timestamp(), 5, 7, 5);

INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga6', current_timestamp(), 6, 5, 5);

INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga7', current_timestamp(), 7, 8, 8);

INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga8', current_timestamp(), 8,2, 4);

INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga1', current_timestamp(), 9, 9, 2);

INSERT INTO	Manga(Nombre, FechaSalida, Numero, idGeneracion, idGuion) VALUES( 'Manga10', current_timestamp(), 10, 8,2);
...
UPDATE AnimeEpisodio SET idAnime = '4' WHERE idAnimeEpisodio = 2;
...
UPDATE AnimeEspecial SET idAnime = '7' WHERE idAnimeEspecial = 2;
...
UPDATE AnimePelicula SET idAnime = '7' WHERE idAnimePelicula = 2;
...
UPDATE ConsolaContro SET idConsola = '4' WHERE idConsolaContro = 2;
...
UPDATE ConsolaVideojuego SET idConsola = '4' WHERE idConsolaVideojuego = 2;
...
UPDATE DistribucionMercancia SET idDistribución = '4' WHERE idDistribucionMercancia = 2;
...
UPDATE GeneracionEntrenador SET idGeneracion = '4' WHERE idGeneracionEntrenador = 2;
...
UPDATE GeneracionMercancia SET idGeneracion = '4' WHERE idGeneracionMercancia = 2;
...
UPDATE ColaboracionCarta SET idColaboracion = '4' WHERE idColaboracionCarta = 2;
...
UPDATE CartaArtista SET idCarta = '4' WHERE idCartaArtista = 2;
...
UPDATE MangaImprenta SET idManga = '4' WHERE idMangaImprenta = 2;
...
UPDATE MercanciaPagina SET idMercancia = '4' WHERE idMercanciaPagina = 2;
...
UPDATE ObjetoTienda SET idObjeto = '4' WHERE idObjetoTienda = 2;
...
UPDATE PokeballTienda SET idPokeball = '4' WHERE idPokeballTienda = 2;
...
UPDATE TemporadaSkin SET idTemporada = '4' WHERE idTemporadaSkin = 2;
...
UPDATE TemporadaVestuario SET idTemporada = '4' WHERE idTemporadaVestuario = 2;
...
UPDATE TorneoVideojuego SET idTorneo = '4' WHERE idTorneoVideojuego = 2;
...
UPDATE VideojuegoEvento SET idVideojuego = '4' WHERE idVideojuegoEvento = 2;
...
UPDATE VideojuegoJugador SET idVideojuego = '4' WHERE idVideojuegoJugador = 2;
...
UPDATE VideoJuegoColaboracion SET idVideojuego = '4' WHERE idVideojuegoColaboracion = 2;
...
UPDATE VideoJuegoContenidodescarga SET idVideojuego = '4' WHERE idVideojuegoContenidodescarga = 2;
...
UPDATE PlataformaAplicacion SET idPlataforma = '4' WHERE idPlataformaAplicacion = 2;
